...
airports= L.geoJson.ajax("assets/airports.geojson", {
    ...
    attribution: 'Airports Data &copy; Data.gov | US states &copy; D3 | Base Map &copy; CartoDB | Made By Chunxue Xu'
}).addTo(mymap);

// 6. Set function for color ramp
colors = chroma.scale('Reds').colors(9);
...
legend.onAdd = function () {
    ...
    div.innerHTML += '<hr><b>Airport with Control Tower<b><br />';
